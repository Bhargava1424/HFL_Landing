...
const AboutUs = () => {
    ...
    <div>
      ...
      <div className="bg-[#ffb72b] flex justify-center items-center rounded-2xl shadow-lg overflow-hidden">
        <div className="p-2 text-center">
          <h1 className="text-xl font-bold text-white sm:text-5xl">About Us</h1>
        </div>
      </div>
        ...
        <div className="flex flex-col items-center justify-center p-4 bg-orange-100 rounded-2xl md:flex-row">
            {/* Image container */}
            <div className="relative flex flex-row items-center w-full mb-4 md:w-1/2 md:flex-col md:items-start md:mb-0">
            {/* First image */}
            <img src={alternative} alt="" className="hidden w-1/2 h-auto mb-0 mr-2 md:w-auto md:mb-2 md:mr-5 md:block" />
            {/* Second image */}
          ...
          <div className="w-full p-2 ml-2 text-center md:w-1/2 md:ml-8 md:p-4 md:text-left">
              <h2 className="mb-2 text-3xl font-bold text-orange-500 md:text-5xl">Mission</h2>
              <div className="flex flex-col items-center md:items-start">
                  <p className="mb-2 text-sm font-normal text-justify text-black md:mb-8 md:text-2xl">
      ...
      <div className="w-full p-2 md:w-1/2 md:p-10">
        <h2 className="mb-4 text-xl font-bold text-center text-orange-500 md:text-6xl bg-slate-300 rounded-2xl">Vision</h2>
        <p className="text-sm text-center text-justify text-black md:text-2xl md:mb-">
      ...
      <div className="flex justify-center w-full md:w-1/2">
        <div className="grid grid-cols-4 gap-4 p-1 md:grid-cols-2 md:p-4">
          <div className="flex flex-col items-center">
            <img src={Checkout} alt="Vision Image 1" className="w-12 h-12 mx-2 mb-1 md:w-24 md:h-24 md:mb-2 md:mr-16" />
            <span className="text-xs font-semibold text-center md:text-base">We Buy</span>
          </div>
          <div className="flex flex-col items-center">
            <img src={Payment} alt="Vision Image 3" className="w-12 h-12 mx-2 mb-1 md:w-24 md:h-24 md:mb-2 md:mr-16" />
            <span className="text-xs font-semibold text-center md:text-base">We Sell</span>
          </div>
          <div className="flex flex-col items-center">
            <img src={Card} alt="Vision Image 4" className="w-12 h-12 mx-2 mb-1 md:w-24 md:h-24 md:mb-2 md:mr-16" />
            <span className="text-xs font-semibold text-center md:text-base">Card</span>
          </div>
          <div className="flex flex-col items-center">
            <img src={School} alt="Vision Image 2" className="w-12 h-12 mx-2 mb-1 md:w-24 md:h-24 md:mb-2 md:mr-16" />
            <span className="text-xs font-semibold text-center md:text-base">Outward Remittances</span>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="p-4 mb-2 bg-orange md:p-8 decoration-wavy rounded-2xl">
      ...
      <div className="flex flex-col items-start my-2 md:flex-row bg-slate-300 rounded-r-2xl sm:bg-white">
        <div className="flex-1 mb-1 md:mb-0 md:max-w-2xl md:mr-8">
          <h2 className="mt-2 mb-2 text-xl text-center text-orange-500 sm:text-4xl md:text-6xl md:mb-4 md:pl-12 md:mt-9">Our People:</h2>
          <div className="md:pl-11">
            <p className="m-2 mb-4 text-sm text-justify text-black md:text-3xl">
        ...
        <div className="justify-center hidden w-full mt-8 md:flex md:mt-0 md:ml-8 md:w-1/2">
          <img src={Network} alt="People" className="object-contain h-auto max-w-full" />
        </div>
      </div>
      <div className="py-4 mb-2 bg-orange-100 md:py-8 rounded-2xl md:mb-4">
  <h1 className="mb-2 text-sm font-bold text-center text-gray-800 sm:text-3xl md:mb-4">
    Board Of Directors
  </h1>
  <p className="mb-4 text-xs font-semibold text-center text-black-600 sm:mb-8 sm:text-base">
  ...
  <div className="grid justify-center grid-cols-2 gap-2 sm:grid-cols-4">
    <div className="mb-4 text-center">
      <div className="relative max-w-xs p-1 mx-1 bg-white rounded-tl-lg rounded-tr-lg shadow-lg rounded-bl-2xl sm:p-6">
        ...
        />
        <h3 className="text-xs font-bold text-gray-800 sm:text-xl">Raghunath Mudumal</h3>
    ...
    <div className="mb-2 text-center md:mb-4">
      <div className="relative max-w-xs p-1 mx-1 bg-white rounded-tl-lg rounded-tr-lg shadow-lg rounded-bl-2xl sm:p-6">
        <img
          ...
          className="object-cover w-12 h-12 mx-auto mb-2 rounded-full sm:w-40 sm:h-40 sm:mb-4"
        />
        <h3 className="text-xs font-bold text-gray-800 sm:text-xl">Venkata Ramana Kokkalla</h3>
    ...
    <div className="mb-4 text-center">
      <div className="relative max-w-xs p-1 mx-1 bg-white rounded-tl-lg rounded-tr-lg shadow-lg rounded-bl-2xl sm:p-6">
        <img
          ...
          className="object-cover w-12 h-12 mx-auto mb-2 rounded-full sm:w-40 sm:h-40 sm:mb-4"
        />
        <h3 className="text-xs font-bold text-gray-800 sm:text-xl">Girish Kulkarni Padmananda</h3>
    ...
    <div className="mb-4 text-center">
      <div className="relative max-w-xs p-1 mx-1 bg-white rounded-tl-lg rounded-tr-lg shadow-lg rounded-bl-2xl sm:p-6">
        <img
          ...
          className="object-cover w-12 h-12 mx-auto mb-2 rounded-full sm:w-40 sm:h-40 sm:mb-4"
        />
        <h3 className="text-xs font-bold text-gray-800 sm:text-xl">Vinay Kumar Beraar</h3>
  ...
  <h1 className="mb-2 text-2xl font-semibold text-center text-black sm:text-4xl">Why Buy Forex via HFL</h1>
  ...
  <div className="text-base font-medium text-black sm:text-xl">
    <div className="relative flex flex-col items-center px-4 py-2 peak-background">
      ...
      <h1 className="w-full text-2xl font-bold text-center sm:text-4xl">Corporate Practices</h1>
      <div className="flex flex-col justify-between w-full sm:flex-row">
        <ul className="mt-4 space-y-2 list-disc sm:ml-40">
          <li className="p-2 text-sm font-semibold sm:text-base sm:p-8">Corporate Governance Practices</li>
          <li className="p-2 text-sm font-semibold sm:text-base sm:p-8">Continuous Improvement in Governance</li>
          <li className="p-2 text-sm font-semibold sm:text-base sm:p-8">Internal Control Systems</li>
        </ul>
        <ul className="mt-4 space-y-2 list-disc sm:mr-40">
          <li className="p-2 text-sm font-semibold sm:text-base sm:p-8">Integration of Operational, Financial, Legal Systems</li>
          <li className="p-2 text-sm font-semibold sm:text-base sm:p-8">Anti-Money Laundering Policy</li>
          <li className="p-2 text-sm font-semibold sm:text-base sm:p-8">Monitoring and Review of Controls</li>
        </ul>
      </div>
    </div>
    <div className="p-4 space-y-2 background-image-list sm:pl-20 sm:pr-20 ">
      <li className="p-2 text-xs sm:text-base sm:p-6">
      ...
      <li className="p-2 text-xs sm:text-base sm:p-6">
        ...
        <h1 className='w-full text-lg font-bold text-center sm:text-4xl'>Our Branches in Hyderabad</h1>
        <div className="flex items-center justify-between w-4/5">
    <div className="flex flex-col items-center w-1/2">
    <h1 className='flex items-center pb-16 mt-8 space-x-2 text-lg font-bold sm:text-4xl'>Somajiguda</h1>
    ...
    <div className="flex flex-col items-center w-1/2">
    <h1 className='flex items-center pb-16 mt-8 space-x-2 text-lg font-bold sm:text-4xl'>Gachibowli</h1>
      <div className="flex items-center pb-16 mt-8 space-x-2">
        <img src={phoneIcon} alt="Phone" className="w-6 h-6 sm:h-10 sm:w-10" />
