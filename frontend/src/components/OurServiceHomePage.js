  ...
  <div className="mb-4">
    ...
    <div className="text-center mb-4">
      ...
      className=" bg-[#FBF8F1] hover: py-2 px-4 hover:bg-white hover:shadow-lg rounded-tl-lg rounded-tr-lg rounded-bl-lg rounded-br-lg p-1  sm:p-6 max-w-xs mx-1">
        ...
        <p className="text-poppins text-xs md:text-base lg:text-xl  text-[#333539]">Convenient and secure forex cards for all your travel needs</p>
    ...
    <div className="text-center mb-4">
      ...
      className="bg-[#FBF8F1] hover: py-2 px-4 hover:bg-white hover:shadow-lg rounded-tl-lg rounded-tr-lg rounded-bl-lg rounded-br-lg  sm:p-6 max-w-xs mx-1">
        ...
        <p className="text-poppins text-xs md:text-base lg:text-xl  text-[#333539]">Effortlessly transfer tuition fees and other remittances abroad with Hyderabad Forex</p>
